...
class MyTestCase(unittest.TestCase):
    ...
    def test_shouldSumTicketsPriceCorrectly(self):
        ...
        # when
        sumOfTickets = round(
            Decimal(ticketMachine.avaiableTickets[firstTicket] + ticketMachine.avaiableTickets[secondTicket]), 1)
    ...
    def test_shouldRaiseIncorrectValueErrorWhenAmountIsNotInteger(self):
        ...
        with self.assertRaises(NiewlasciwaIloscMonet, ) as context:
            userCoinContainer.potwierdzIlosc(0.3)
    ...
    def test_shouldRaiseIncorrectValueErrorWhenAmountIsNegative(self):
        ...
        with self.assertRaises(NiewlasciwaIloscMonet, ) as context:
            userCoinContainer.potwierdzIlosc(-5)
